# [[Computação/Programação/Python/Python|Python]] - Funções
## len():
...
[[Computação/Programação/Python/Python|Python]] não aceita operações de tipo de dados diferentes, para isso possui funções de conversão de tipo de dados.
```python
	int("5")
	#return 5
